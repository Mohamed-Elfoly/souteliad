...
//   { to: '/Personal/edit',     label: 'تعديل بيانات حسابي الشخصي', hideFor: [] },
        ...
        <div className="flex items-center gap-2 shrink-0">
          {isAuthenticated ? (
            <>
              ...
              <div className="relative" ref={settingsRef}>
                <button
                  className={`p-2 rounded-lg transition-colors cursor-pointer ${settingsOpen ? 'bg-orange-50 text-[#EB6837]' : 'text-gray-500 hover:bg-gray-100 cursor-pointer'}`}
                  onClick={() => { setSettingsOpen((o) => !o); setBellOpen(false); }}
                >
                  <Settings size={20} />
                </button>
