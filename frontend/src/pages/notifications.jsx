...
// const columns = [
//   { key: 'user', label: 'اسم الطالب', render: (row) => `${row.user?.firstName || ''} ${row.user?.lastName || ''}` },
//   { key: 'sender', label: 'اسم الدكتور', render: (row) => row.sender?.firstName || 'د. مي عوني' },
//   { key: 'type', label: 'نوع الإشعار', render: (row) => row.type || 'إشعار' },
//   { key: 'message', label: 'ملخص قصير للإشعار', render: (row) => row.message || '' },
//   {
//     key: 'createdAt',
//     label: 'تاريخ الإشعار',
...
//   const notifications = notifsData?.data?.data?.data || [];

//   return (
//     <div className="main-content2">
//       <h1 className="page-title">قائمة الإشعارات</h1>
...
//           isLoading={isLoading}
//           renderActions={() => (
//             <button className="btn-orange-small">عرض الإشعار</button>
//           )}
//         />
//       </div>
//     </div>
